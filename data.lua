    ...
    Consumables = {
        ...
        Trophy = {
            ...
            dropdownCallbacks = {
                ...
                {name = "CollectibleFragment", showIcon=false, filterCallback = GetFilterCallbackForSpecializedItemtype({SPECIALIZED_ITEMTYPE_TROPHY_COLLECTIBLE_FRAGMENT})},
                {name = "Key", showIcon=false, filterCallback = GetFilterCallbackForSpecializedItemtype({SPECIALIZED_ITEMTYPE_TROPHY_KEY})},
                {name = "MaterialUpgrader", showIcon=false, filterCallback = GetFilterCallbackForSpecializedItemtype({SPECIALIZED_ITEMTYPE_TROPHY_MATERIAL_UPGRADER})},
                {name = "RuneboxFragment", showIcon=false, filterCallback = GetFilterCallbackForSpecializedItemtype({SPECIALIZED_ITEMTYPE_TROPHY_RUNEBOX_FRAGMENT})},
                {name = "Toy", showIcon=false, filterCallback = GetFilterCallbackForSpecializedItemtype({SPECIALIZED_ITEMTYPE_TROPHY_TOY})},
                {name = "UpgradeFragment", showIcon=false, filterCallback = GetFilterCallbackForSpecializedItemtype({SPECIALIZED_ITEMTYPE_TROPHY_UPGRADE_FRAGMENT})},
            },
        },
    },
    Crafting = {
