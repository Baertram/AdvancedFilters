...
local strings = {
    ...
    lamHideSubFilterLabel = "Cacher le nom des sous-catégories",
    lamHideSubFilterLabelTT = "Retire le nom des sous-catégories affiché en haut à gauche de la fenêtre d'inventaire.",
    ...
    lamHideCharBoundAtBankDeposit = "Cacher les objets liés au personnage",
    lamHideCharBoundAtBankDepositTT = "Masque les objets liés au personnage dans l'onglet |cFFFFFFDépôt bancaire|r.",
